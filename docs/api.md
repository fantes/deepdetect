...
timesteps     | int            | yes      | N/A            | Number of timesteps for time models (LSTM/NBEATS...) : this sets the length of sequences that will be given for learning
offset        | int            | yes      | N/A            | Offset beween start point of sequences with connector `cvsts`, defining the overlap of input series
forecast      | int            | yes      | N/A       | for nbeats model, this gives the length of the forecast, backcast will be timesteps - forecast 
