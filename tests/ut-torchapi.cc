...
TEST(torchapi, service_predict)
{
    ...
    std::string jstr = "{\"mllib\":\"torch\",\"description\":\"resnet-50\",\"type\":\"supervised\",\"model\":{\"repository\":\"" +  incept_repo + "\"},\"parameters\":{\"input\":{\"connector\":\"image\",\"height\":224,\"width\":224}}}";
    std::string joutstr = japi.jrender(japi.service_create(sname,jstr));
    ASSERT_EQ(created_str,joutstr);

    // predict
    std::string jpredictstr = "{\"service\":\"imgserv\",\"parameters\":{\"input\":{\"height\":224,\"width\":224},\"output\":{\"best\":1}},\"data\":[\"" + incept_repo + "cat.jpg\"]}";
